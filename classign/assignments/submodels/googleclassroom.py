    ...
    def update_courses(self):
        ...
        for course in courses:
            ...
            try:
                ...
                GoogleClassroomCourse.objects.create(lms=self, course_id=course_id,
                                                     name=course_name)
        return courses
    ...
    def get_todo(self):
        ...
        for coursee in y:
            ...
            try:
                ...
                GoogleClassroomAssignment.objects.create(
        ...
        return self.googleclassroomassignment_set.all()


class GoogleClassroomCourse(Course):
    """
    ...
    """
    lms_name = models.CharField(max_length=20, default="google_classroom")
    lms = models.ForeignKey(to=GoogleClassroom, on_delete=models.CASCADE)
    course_id = models.CharField(max_length=100)
    name = models.CharField(max_length=200)


class GoogleClassroomAssignment(Assignment):
    """
